...
#ifdef CONFIG_HTC_BATT_DCJACK
static const char *dcjack_event[] = {
    [HTC_BATT_SMB5_CHG_EVENT_TYPEC_MODE]    = "TYPEC_MODE",
    [HTC_BATT_SMB5_CHG_EVENT_APSD]  = "APSD",
    [HTC_BATT_SMB5_CHG_EVENT_OK_TO_PD]  = "OK_TO_PD",
    [HTC_BATT_SMB5_CHG_EVENT_PD_ACTIVE] = "PD_ACTIVE",
    [HTC_BATT_SMB5_CHG_EVENT_PD_ICL]    = "PD_ICL",
    [HTC_BATT_SMB5_CHG_EVENT_OTG]   = "OTG",
    [HTC_BATT_SMB5_CHG_EVENT_CC_ORIENTATION]    = "CC_ORIENTATION",
    [HTC_BATT_SMB5_CHG_EVENT_MAX]   = "MAX",
};

static const char *dcjack_stage[] = {
    [DETECT_STAGE_DCJACK_NONE]  = "DCJACK_NONE",
    [DETECT_STAGE_DCJACK_DISABLED]   = "DCJACK_DISABLED",
    [DETECT_STAGE_DCJACK]   = "DCJACK",
    [DETECT_STAGE_MAX]  = "MAX",
};
...
int htc_battery_smb5_notify(enum htc_batt_smb5_chg_event event, int val)
{
	...
	pr_err("notify charger for %s:%s(%d)\n",dcjack_stage[stage], dcjack_event[event], val);
